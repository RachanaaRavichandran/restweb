...
<body>
  ...
  <section class="menu" id="menu">
    ...
    <div class="menu-items">
      <div class="dish">
        <img src="https://images.unsplash.com/photo-1606755962773-0e754a07d07a?auto=format&fit=crop&w=500&q=80" alt="Pizza">
        <h3>Firewood Pizza</h3>
        <p>Classic Italian style pizza baked in a wood-fired oven.</p>
      </div>
      <div class="dish">
        <img src="https://images.unsplash.com/photo-1551218808-94e220e084d2?auto=format&fit=crop&w=500&q=80" alt="Pasta">
        <h3>Truffle Pasta</h3>
        <p>Rich creamy sauce with truffle essence and parmesan.</p>
      </div>
      <div class="dish">
        <img src="https://images.unsplash.com/photo-1601050690597-1e8a1a5c8b6f?auto=format&fit=crop&w=500&q=80" alt="Burger">
        <h3>Gourmet Burger</h3>
        <p>Juicy beef patty with crispy fries and house dressing.</p>
      </div>
      <div class="dish">
        <img src="https://images.unsplash.com/photo-1605478445038-8f74c1d50c26?auto=format&fit=crop&w=500&q=80" alt="Salad">
        <h3>Caesar Salad</h3>
        <p>Fresh greens with tangy dressing and grilled chicken.</p>
      </div>
      <div class="dish">
        <img src="https://images.unsplash.com/photo-1562967916-eb82221dfb36?auto=format&fit=crop&w=500&q=80" alt="Dessert">
        <h3>Chocolate Lava Cake</h3>
        <p>Warm chocolate cake with molten center and ice cream.</p>
      </div>
      <div class="dish">
        <img src="https://images.unsplash.com/photo-1627308595187-263396ffccf4?auto=format&fit=crop&w=500&q=80" alt="Drink">
...
```
## OUTPUT:
![alt text](<Screenshot 2025-10-05 203739-1.png>) 

![alt text](<Screenshot 2025-10-05 203810-1.png>) 

![alt text](<Screenshot 2025-10-05 203834-1.png>)

![alt text](<Screenshot 2025-10-05 203849-1.png>)
